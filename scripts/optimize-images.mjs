...
const jobs = [
  ...
  { src: 'expavio.png', out: 'expavio-logo.png', width: 480, quality: 82, format: 'png' },

  // Full-bleed / large photos
  { src: 'hero.png', out: 'hero.webp', width: 1920, quality: 72 },
  { src: 'heroar.png', out: 'heroar.webp', width: 1920, quality: 72 },
  { src: 'foreign-investor.png', out: 'foreign-investor.webp', width: 1400, quality: 72 },
  { src: 'investor-hero.png', out: 'investor-hero.webp', width: 1400, quality: 72 },
  { src: 'investor-journey.png', out: 'investor-journey.webp', width: 1600, quality: 70 },
  { src: 'about-hero.png', out: 'about-hero.webp', width: 1920, quality: 72 },
  { src: 'about-hero-ar.png', out: 'about-hero-ar.webp', width: 1920, quality: 72 },
  { src: 'about-story.png', out: 'about-story.webp', width: 1200, quality: 72 },
  { src: 'about-method.png', out: 'about-method.webp', width: 1600, quality: 70 },
...
async function optimizeOne(job) {
  ...
  if (job.format === 'png') {
    await pipeline.png({ quality: job.quality, compressionLevel: 9 }).toFile(output)
  } else {
